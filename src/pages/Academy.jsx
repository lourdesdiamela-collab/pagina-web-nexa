...
const Academy = () => {
  ...
  const articles = [
    ...
    {
      title: 'Qué necesita una marca para verse más profesional',
      category: 'Marca',
      type: 'Guía',
      icon: FileText,
      readTime: '8 min',
    ...
    {
      title: 'Errores comunes en campañas de Meta Ads',
      category: 'Campañas',
      type: 'Video',
      icon: Video,
      readTime: '12 min',
    ...
    {
      title: 'Redes sociales: presencia, estrategia y constancia',
      category: 'Redes sociales',
      type: 'Artículo',
      icon: BookOpen,
      readTime: '7 min',
    ...
    <div className="page-wrapper" style={{ paddingTop: '120px' }}>
      ...
      <section className="academy-hero" style={{ textAlign: 'center', marginBottom: '60px' }}>
        <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p className="section-subtitle">Ideas, guías y contenidos reales para entender mejor el marketing, ordenar tu presencia digital y hacer crecer tu negocio con más claridad.</p>
          ...
          <div className="academy-search" style={{ position: 'relative', marginTop: '40px' }}>
            ...
            <input 
              type="text" 
              placeholder="Buscar estrategias, guías, herramientas..." 
            ...
            {filteredArticles.map((article, i) => (
              ...
              >
                ...
                <div style={{ padding: '30px', flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                  ...
                  <Link to={`/aprende/${article.slug}`} style={{ color: 'var(--lima)', fontWeight: 800, display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
