      ...
      <div className="container">
        <div className="footer-inner">
          ...
          <div className="footer-links">
            ...
            <Link href="/portal" className="footer-portal-link">Ãrea Clientes</Link>
          </div>
        </div>
        <div className="footer-bottom">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <span style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.4)', fontWeight: 600 }}>Â© 2026 NEXA STRATEGY. LAB DIGITAL ESTRATÃGICO.</span>
            <div style={{ display: 'flex', gap: '20px', marginTop: '10px', fontSize: '0.9rem', color: 'rgba(255,255,255,0.6)' }}>
              <a href="mailto:hola@nexaarg.com" style={{ color: 'inherit', textDecoration: 'none' }}>hola@nexaarg.com</a>
