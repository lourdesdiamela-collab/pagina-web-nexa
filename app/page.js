  ...
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .channels-list { list-style: none; display: flex; flex-direction: column; gap: 12px; }
        .channels-list-item {
          display: flex;
          align-items: center;
          gap: 10px;
        ...
        @media (max-width: 900px) {
          ...
          .hero-badge, .hero-metrics { justify-content: center; }
          ...
          .section-tag-recover { margin-left: auto; margin-right: auto; }
